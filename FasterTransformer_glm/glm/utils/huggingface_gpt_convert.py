...
import os
import sys
sys.path.append('../../gpt_glm_10b_chinese')
from modeling_gpt2_glm import GPT2Model
...
def split_and_convert(args):
    ...
    for name, param in model.named_parameters():
        ...
        if name == 'wbpe.weight':
            param.detach().cpu().numpy().astype(np_weight_data_type).tofile(saved_dir + "model.wbpe.bin")
